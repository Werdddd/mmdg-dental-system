      ...
      <div className="flex flex-1 flex-col items-center justify-center bg-gray-50 px-6 py-12 sm:px-12">
        <div className="w-full max-w-[400px]">
          ...
          <div className="mb-8 flex flex-col items-center gap-3 text-center">
            <div className="relative flex h-[68px] w-[68px] items-center justify-center overflow-hidden rounded-[18px] bg-white shadow-xl shadow-violet-300/40">
              <Image
                src={logoImage}
          ...
          <p className="mt-6 text-center text-[11px] text-gray-400">
            © {new Date().getFullYear()} Mendez Multispecialty Dental Group. All
            rights reserved.
          </p>
        </div>
      </div>
